...
/**
 * Copy one Intent object to another
 */
public class IntentCopyStatement extends IntentStatement {

    private final int left;
    private final int right;

    public IntentCopyStatement(int left, int right, IMethod m) {
        super(m);
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        ...
        IntentCopyStatement other = (IntentCopyStatement) obj;
        if (left != other.left) {
            return false;
        }
