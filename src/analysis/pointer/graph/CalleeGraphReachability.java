 ...
 */
public final class CalleeGraphReachability {
    public static final boolean USE_CALLEE_GRAPH_REACH = !ProgramPointReachability.USE_TUNNELS;
    /**
     ...
     */
    public CalleeGraphReachability(ProgramPointReachability ppr, PointsToGraph g) {
        this.ppr = ppr;
        this.g = g;
    }
     ...
     */
    private void addToCallerTree(/*CGNode*/int caller, /*Set<OrderedPair<IMethod,Context>>*/
                                 IntSet setToAdd) {
        ...
        if (newlyReachable.isEmpty()) {
            ...
            while (callSitesCallingCaller.hasNext()) {
                addToCallerTree(getCGNodeForCallSite(callSitesCallingCaller.next()), newlyReachable);
            }
        }
    }
