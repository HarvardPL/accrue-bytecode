 ...
 */
public class LocalToArrayStatement<IK extends InstanceKey, C extends Context> extends PointsToStatement<IK, C> {
    /**
     * Array assigned into
     */
